 ...
 */
export function getAnnualMortalityRate(params) {
 ...
 */
export function getSurvivalProbability(currentAge, targetAge, gender, healthStatus) {
 ...
 */
export function calculateLifeExpectancy(params) {
    ...
    for (let futureAge = currentAge + 1; futureAge <= 120; futureAge++) {
        const survivalToAge = getSurvivalProbability(currentAge, futureAge, gender, healthStatus);
 ...
 */
export function simulateSurvival(params, rng) {
 ...
 */
export function simulateCouplesSurvival(userParams, spouseParams, rng) {
 ...
 */
export function getPercentileLifeExpectancy(params, percentile) {
    const { currentAge, gender, healthStatus } = params;
    for (let age = currentAge + 1; age <= 120; age++) {
        const survivalProb = getSurvivalProbability(currentAge, age, gender, healthStatus);
