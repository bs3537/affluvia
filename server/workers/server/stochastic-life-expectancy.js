 ...
 */
export function generateStochasticLifeExpectancy(params, rng) {
 ...
 */
export function generateCouplesStochasticLifeExpectancy(userParams, spouseParams, correlation = 0.4, rng) {
 ...
 */
function generateStochasticLifeExpectancyWithRandom(params, random, rng) {
    const { baseLifeExpectancy, currentAge, gender, healthAdjustment = 0 } = params;
 ...
 */
export function analyzeLifeExpectancyDistribution(params, iterations = 1000) {
    const results = [];
