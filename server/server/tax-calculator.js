...
exports.calculateCombinedTaxRate = calculateCombinedTaxRate;
exports.getTaxFriendlyStates = getTaxFriendlyStates;
exports.compareStateTaxes = compareStateTaxes;
...
function calculateCombinedTaxRate(annualIncome, retirementState, filingStatus, isRetired = true, age = 65, spouseAge) {
...
function compareStateTaxes(annualIncome, currentState, proposedState, filingStatus, age = 65, spouseAge) {
...
function calculateCapitalGainsTax(capitalGainsIncome, totalTaxableIncome, filingStatus) {
