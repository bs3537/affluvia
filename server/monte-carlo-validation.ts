...
export class ProbabilityUtils {
   ...
   */
  static toPercentage(decimal: number): number {
...
export class MonteCarloValidator {
   ...
   */
  static validateParameters(params: RetirementMonteCarloParams): ValidationResult {
   ...
   */
  private static validateDemographics(params: RetirementMonteCarloParams, errors: ValidationError[], warnings: ValidationError[]): void {
    // Age validation
   ...
   */
  private static validateExpenses(params: RetirementMonteCarloParams, errors: ValidationError[], warnings: ValidationError[]): void {
   ...
   */
  private static validateAssetAllocation(params: RetirementMonteCarloParams, errors: ValidationError[], warnings: ValidationError[]): void {
   ...
   */
  private static validateMarketAssumptions(params: RetirementMonteCarloParams, errors: ValidationError[], warnings: ValidationError[]): void {
   ...
   */
  static checkRequiredParameters(params: RetirementMonteCarloParams): string[] {
    const missing: string[] = [];

    if (!params.currentAge) missing.push('currentAge');
    if (!params.retirementAge) missing.push('retirementAge');
    if (!params.lifeExpectancy) missing.push('lifeExpectancy');
    if (params.currentRetirementAssets === undefined || params.currentRetirementAssets === null) missing.push('currentRetirementAssets');
    if (params.annualRetirementExpenses === undefined || params.annualRetirementExpenses === null) missing.push('annualRetirementExpenses');
    if (!params.expectedReturn) missing.push('expectedReturn');
    if (!params.returnVolatility) missing.push('returnVolatility');
    if (!params.inflationRate) missing.push('inflationRate');
    if (params.taxRate === undefined || params.taxRate === null) missing.push('taxRate');
    if (!params.withdrawalRate) missing.push('withdrawalRate');
    if (params.stockAllocation === undefined || params.stockAllocation === null) missing.push('stockAllocation');
    if (params.bondAllocation === undefined || params.bondAllocation === null) missing.push('bondAllocation');
...
export class ParameterExtractor {
   ...
   */
  static extractNumber(value: any, fieldName: string, defaultValue?: number): number | undefined {
   ...
   */
  static extractProbability(value: any, fieldName: string, defaultValue?: number): number | undefined {
   ...
   */
  static extractBoolean(value: any, defaultValue: boolean = false): boolean {
   ...
   */
  static extractString(value: any, allowedValues?: string[], defaultValue?: string): string | undefined {
